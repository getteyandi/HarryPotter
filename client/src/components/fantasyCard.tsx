  ...
  const renderIcon = () => {
    if (type === "potion") {
      return (
        ...
        >
          <path
            d="M14 11a1 1 0 1 1 1 1 1 1 0 0 1-1-1zm-5 7a1 1 0 1 0-1-1 1 1 0 0 0 1 1zm-6-4a8.992 8.992 0 0 1 6-8.478V3H8a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2h-1v2.522A9 9 0 1 1 3 14zm2.134-1.312c5.988-2.015 7.655.875 13.757 2.5A6.943 6.943 0 0 0 13.75 7.23a1 1 0 0 1-.75-.968V3h-2v3.262a1 1 0 0 1-.75.968 6.989 6.989 0 0 0-5.116 5.458zm-.077 2.152a6.989 6.989 0 0 0 13.206 2.267C11.887 15.384 10.72 12.6 5.057 14.84z"
            stroke="#E1CBA5"
            fill="#041119"
          ></path>
        </svg>
