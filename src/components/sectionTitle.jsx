  ...
  return (
    <div className=" max-w-7xl z-30 mx-auto relative flex items-center justify-center ">
      ...
      <div className={`absolute  ${backgroundColor} px-11`}>
        {title && (
          <div className="relative text-nowrap w-fit">
            <p className=" text-4xl font-bold text-hp-yellow">{title}</p>
            <p className="absolute  top-[0.5px] left-[0.5px] text-4xl font-bold text-hp-royal">
              {title}
            </p>
            <p className="absolute top-[1.5px] left-[1.5px] text-4xl font-bold text-hp-yellow">
              {title}
            </p>
          </div>
        )}
